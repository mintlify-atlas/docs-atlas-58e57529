...
<Steps>
  ...
  <Step title="Start using tools immediately">
    ...
    All 47 tools are available from the sidebar or command palette (`Cmd/Ctrl + K`).
  </Step>
</Steps>
...
<Note>
  **Benefits of PWA installation:**
  - Offline access to all 47 tools
...
<Card icon="wifi-slash">
  **All 47 tools function without an internet connection** after the initial load. The service worker caches:
