...
description: Deep dive into the registry → engine → workbench pattern that powers all 47 tools
---
...
The workbench is a **unified UI component** used by all 47 tools. It handles:
