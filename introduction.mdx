---
title: Introduction
description: Kayston's Forge is a privacy-first browser developer utilities suite with 47 tools for encoding, conversion, beautification, and data transformation.
---
...
1. **Registry** (`lib/tools/registry.ts`) — Defines all 47 tools with metadata (id, name, category, icon, keywords)
