...
description: Quick access to all 47 tools with fuzzy search
---

The Command Palette provides instant access to any of the 47 tools in Kayston's Forge with keyboard-driven fuzzy search.
