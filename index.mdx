...
description: Privacy-first browser developer utilities suite with 47 tools for encoding, formatting, and data transformation
mode: custom
---
...
<div className="mt-16 mb-16 max-w-5xl mx-auto px-6">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="p-6 rounded-2xl border border-gray-200 dark:border-[#27272a] bg-gray-50 dark:bg-[#1a1d27]">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        Installable PWA with service worker caching. Access all 47 tools offline, on the go, or in restricted network environments.
      </p>
    </div>
